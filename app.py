...
# --- AYARLAR ---
# Yüklediğin dosyadaki şifre:
SIFRE = "AIzaSyBsib1bPwnp2NZaUk7SHNCPXQlmFi04j4c"
genai.configure(api_key=SIFRE)

# --- MODEL AYARI (DÜZELTİLDİ) ---
# Hata 'gemini-2.5-flash' yazmasından kaynaklanıyordu. Doğrusu 1.5'tir.
...
"""
# Talimatı modele tanımlıyoruz (Düzeltildi)
